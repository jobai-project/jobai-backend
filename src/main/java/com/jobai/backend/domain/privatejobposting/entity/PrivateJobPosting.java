package com.jobai.backend.domain.privatejobposting.entity;
...
public class PrivateJobPosting {
     ...
     */
    public void setNormalizedLocation(Location location) {
        this.location = Objects.requireNonNull(location, "region").getLabel();
    }
}